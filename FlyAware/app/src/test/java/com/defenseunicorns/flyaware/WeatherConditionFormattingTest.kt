...
class WeatherConditionFormattingTest {
    
    @Test
    fun `test single weather condition parsing`() {
    ...
    @Test
    fun `test heavy weather condition parsing`() {
        val metarDto = MetarDto(
            icaoId = "KORD",
            rawText = "KORD 212351Z 21016G37KT 10SM +RA FEW044 33/23 A2978 RMK AO2",
            observationTime = 1750549860,
    ...
    @Test
    fun `test light weather condition parsing`() {
        val metarDto = MetarDto(
            icaoId = "KORD",
    ...
    @Test
    fun `test vicinity weather condition parsing`() {
        val metarDto = MetarDto(
            icaoId = "KORD",
    ...
    @Test
    fun `test multiple weather conditions parsing`() {
        val metarDto = MetarDto(
            icaoId = "KORD",
    ...
    @Test
    fun `test wxString weather condition parsing`() {
        val metarDto = MetarDto(
            icaoId = "KORD",
    ...
    @Test
    fun `test empty weather conditions parsing`() {
        val metarDto = MetarDto(
            icaoId = "KMCI",
